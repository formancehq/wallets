...
// dependency use this version in the ledger repository
replace github.com/formancehq/ledger/pkg/client v0.0.0-00010101000000-000000000000 => github.com/formancehq/ledger/pkg/client v0.0.0-20250117163346-1a4b9a580763

require (
	github.com/formancehq/formance-sdk-go/v3 v3.4.1
	github.com/formancehq/go-libs/v2 v2.2.3-0.20250404101012-685b9b00417d
	github.com/formancehq/ledger v0.0.0-20250120112206-ee7425930699
...
require (
	...
	github.com/formancehq/ledger/pkg/client v0.0.0-00010101000000-000000000000 // indirect
