...
import (
	...
	walletcomponent "github.com/formancehq/wallets/plugins/fctl/component"
	"github.com/formancehq/wallets/plugins/fctl/core"
)
...
func mustLifecycle() *component.Component {
	plugin := core.Plugin{}
	configured, err := component.New(component.Providers{Command: plugin}, walletcomponent.Descriptor())
	if err != nil {
		panic(fmt.Sprintf("configure wallets portable component: %v", err))
	}
	return configured
}
